...
function Header({ onLoginClick, onNav, loggedIn }) {
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 px-4 sm:px-6 lg:px-8 py-4">
      <div className="flex items-center gap-3 text-[#0d1b19]">
      ...
      <nav className="hidden lg:flex items-center gap-8 text-sm font-medium">
        <a
          className="hover:text-[#13ecc8] transition-colors"
          href="#"
      ...
      <div className="flex items-center gap-4">
        {!loggedIn && (
          <button
            className="hidden lg:flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-md h-10 px-4 bg-[#13ecc8] text-[#0d1b19] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-opacity-90 transition-colors"
